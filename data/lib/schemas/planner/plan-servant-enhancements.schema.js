...
exports.PlanServantEnhancementsSchema = void 0;
const mongoose_1 = require("mongoose");
const validators_1 = require("../../validators");
/**
 * Mongoose schema for the `PlanServantEnhancements.skills` property.
 */
const PlanServantEnhancementsSkillsSchema = new mongoose_1.Schema({
    1: {
        type: Number,
        min: 1,
        max: 10,
 ...
 */
exports.PlanServantEnhancementsSchema = new mongoose_1.Schema({
    level: {
        type: Number,
        min: 1,
        max: 100,
